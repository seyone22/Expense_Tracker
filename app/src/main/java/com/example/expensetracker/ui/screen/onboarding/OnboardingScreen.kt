...
fun OnboardingSheet(
    ...
    Column(
        ...
        Text(text = "Hello! How should we call you?")
        OutlinedTextField(
            modifier = Modifier.padding(0.dp, 8.dp),
            value = username,
            onValueChange = {
                username = it
                viewModel.updateUiState(viewModel.metadataUiState.metadataDetails.copy(usernameMetadata = Metadata(6,"USERNAME",username)))
            },
            label = { Text("Username") },
            singleLine = true,
                ...
                currencyList.currenciesList.forEach { currency ->
                    DropdownMenuItem(
                        ...
                        onClick = {
                            ...
                            viewModel.updateUiState(viewModel.metadataUiState.metadataDetails.copy(baseCurrencyMetadata = Metadata(5,"BASECURRENCYID",currentCurrency.currencyId.toString())))
